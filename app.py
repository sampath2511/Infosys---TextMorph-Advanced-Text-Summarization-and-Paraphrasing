...
SMTP_PORT = 587
SENDER_EMAIL = "sampathkkummari@gmail.com"
SENDER_PASSWORD = "tabs hepn mplp pmdk" # Use an App Password, not your real password
...
ngrok.set_auth_token("39YbWLzzgKVmJWO1kMrnOAuW0pe_7BRTa9UwE8mKUjgK27drb")
